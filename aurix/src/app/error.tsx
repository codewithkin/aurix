...
function ErrorPage({ error, reset }: { error: { message: string }, reset: () => void }) {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col justify-center items-center text-center">
        ...
        <p className="bg-gray-900 hover:cursor-pointer border-2 border-purple-600 rounded-md my-2 text-white py-2 px-8 hover:border-orange-600 hover:shadow-xl transition duration-300">
            {error.message}
        </p>
